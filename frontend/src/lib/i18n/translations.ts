...
export const T: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    // ─── Wave 3 — Dashboard ─────────────────────────────────────────────────
    dash_wallet_changed: "Wallet account changed in your extension",
    dash_active_wallet: "New:", dash_viewing_wallet: "Current:",
    dash_switch_to: "Switch to {a}…", dash_stay_on: "Keep {a}…",
    ...
    dash_risk_drift_desc: "Next rebalance if >8% drift from target weight.",
    ...
    // ─── Wave 3 — Navbar new items ───────────────────────────────────────────
    nav_ai_insights: "AI Insights",
    nav_faucet: "Faucet",
    nav_faucet_locked_hint: "Switch to Testnet to access the faucet",

    // ─── Wave 3 — AI Insights page ──────────────────────────────────────────
    ai_title: "AI Insights",
    ai_subtitle: "Medium-term intelligence · Scout SoSoMon",
    ai_updated_at: "updated {time}",
    ai_refresh: "Refresh",
    ai_loading: "Loading analysis...",
    ai_personalized_title: "Personalized insights",
    ai_view_index_link: "view index →",
    ai_view_risk_link: "view risk →",
    ai_no_alerts: "No alerts at the moment — well diversified portfolio.",
    ai_portfolio_ok: "Portfolio in good shape — no opportunities or risks identified.",
    ai_connect_prompt: "Connect your wallet to see personalized insights",
    ai_connect_btn: "Connect wallet",
    ai_performance_title: "Index Performance",
    ai_vs_btc: "vs BTC benchmark",
    ai_7d_col: "7 days",
    ai_30d_col: "30 days",
    ai_disclaimer: "Insights generated by Scout SoSoMon with real SoDEX and SoSoValue SSI data. Not investment advice.",

    // ─── Wave 3 — Dashboard new strings ─────────────────────────────────────
    dash_token_holdings: "Token Holdings",
    dash_transaction_history: "Transaction History",
    dash_no_perf_data: "No performance data yet — chart fills in hourly.",
    dash_chart_accumulating: "Chart accumulates hourly — check back later for the full curve.",
    dash_alert_up: "rose",
    dash_alert_down: "fell",
    dash_this_week: "this week",
    dash_current_value_label: "current value",
    dash_updating: "updating…",
    dash_nav_return_label: "NAV Return % since inception",

    // ─── Wave 3 — Index detail new strings ──────────────────────────────────
    idx_candidate_badge: "candidate",
    idx_concentration_risk: "Concentration Risk (HHI)",
    idx_effective_n: "effective n:",
    idx_max_label: "largest:",
    idx_vs_btc_label: "vs BTC 30d:",
    idx_alpha_label: "alpha",

    // ─── Wave 3 — What's New ─────────────────────────────────────────────────
    wn_wave3_label: "Wave 3 · Jul 2026",

    // ─── Admin — EN/PT only ──────────────────────────────────────────────────
    admin_refresh_all: "Refresh all data",
    admin_click_refresh: "Click ↻ to load balances",
    admin_possible_txs: "Possible transactions",
    admin_gas_price_now: "Gas price now",
    admin_eth_low: "ETH low — consider topping up soon",
    admin_reserve_title: "Admin Reserve",
    admin_investor_portfolio: "Investor Portfolio",
    admin_aum_prefix: "Total AUM: $",
    admin_no_portfolios: "No portfolios on this network",
    admin_th_wallet: "Wallet",
    admin_th_index: "Index",
    admin_th_entry: "Entry",
    admin_th_deposited: "Deposited",
    admin_th_current: "Current",
    admin_th_shares: "Shares",
    admin_investments_one: "investment",
    admin_investments_many: "investments",
    admin_of: "of",
    admin_per_page: "/ page",
    admin_investor_current: "Current Value",
    admin_buys_ok: "✓ buys OK",
    admin_buys_pending: "⏳ pending",
    admin_entry_nav: "Entry NAV: $",
    admin_pool_participation: "Pool Participation",
    admin_shares_this: "Shares from this investment",
    admin_pool_pct: "% of Pool",
    admin_basket_comp: "Basket Composition",
    admin_sodex_pool_pct: "% of SoDEX pool",
    admin_testnet_warn_title: "Testnet Mode — financial data is simulated",
    admin_testnet_warn_body: "Testnet portfolios are simulated in the database. SoDEX testnet is a separate environment without real funds — the reconciliation below has no financial significance.",
    admin_investor_col: "Investor",
    admin_usd_col: "USD",
  ...
  pt: {
    ...
    dash_wallet_changed: "Conta alterada na carteira — deseja mudar ou manter a atual?",
    dash_active_wallet: "Nova:", dash_viewing_wallet: "Atual:",
    dash_switch_to: "Mudar para {a}…", dash_stay_on: "Manter {a}…",
    ...
    dash_risk_drift_desc: "Próximo rebalance se desvio >8% do peso alvo.",
    ...
    nav_ai_insights: "AI Insights",
    nav_faucet: "Faucet",
    nav_faucet_locked_hint: "Mude para Testnet para acessar o faucet",
    ai_title: "AI Insights",
    ai_subtitle: "Inteligência de médio prazo · Scout SoSoMon",
    ai_updated_at: "atualizado {time}",
    ai_refresh: "Atualizar",
    ai_loading: "Carregando análise...",
    ai_personalized_title: "Insights personalizados",
    ai_view_index_link: "ver índice →",
    ai_view_risk_link: "ver risco →",
    ai_no_alerts: "Sem alertas no momento — portfólio bem diversificado.",
    ai_portfolio_ok: "Portfólio em boa forma — sem oportunidades ou riscos identificados.",
    ai_connect_prompt: "Conecte sua carteira para ver insights personalizados",
    ai_connect_btn: "Conectar carteira",
    ai_performance_title: "Performance dos índices",
    ai_vs_btc: "vs BTC benchmark",
    ai_7d_col: "7 dias",
    ai_30d_col: "30 dias",
    ai_disclaimer: "Insights gerados pelo Scout SoSoMon com dados reais do SoDEX e SoSoValue SSI. Não constituem recomendação de investimento.",
    dash_token_holdings: "Composição da Carteira",
    dash_transaction_history: "Histórico de Transações",
    dash_no_perf_data: "Sem dados de performance ainda — gráfico atualiza a cada hora.",
    dash_chart_accumulating: "Gráfico acumula dados por hora — volte mais tarde para a curva completa.",
    dash_alert_up: "subiu",
    dash_alert_down: "caiu",
    dash_this_week: "esta semana",
    dash_current_value_label: "valor atual",
    dash_updating: "atualizando…",
    dash_nav_return_label: "Retorno NAV % desde o início",
    idx_candidate_badge: "candidato",
    idx_concentration_risk: "Risco de Concentração (HHI)",
    idx_effective_n: "n efetivo:",
    idx_max_label: "maior:",
    idx_vs_btc_label: "vs BTC 30d:",
    idx_alpha_label: "alpha",
    wn_wave3_label: "Wave 3 · Jul 2026",
    ...
    // ─── Admin — EN/PT only ──────────────────────────────────────────────────
    admin_refresh_all: "Atualizar todos os dados",
    admin_click_refresh: "Clique em ↻ para carregar saldos",
    admin_possible_txs: "Transações possíveis",
    admin_gas_price_now: "Gas price agora",
    admin_eth_low: "ETH baixo — considere repor em breve",
    admin_reserve_title: "Reserva Admin",
    admin_investor_portfolio: "Portfólio de Investidores",
    admin_aum_prefix: "AUM total: $",
    admin_no_portfolios: "Nenhum portfólio nesta rede",
    admin_th_wallet: "Carteira",
    admin_th_index: "Índice",
    admin_th_entry: "Entrada",
    admin_th_deposited: "Depositado",
    admin_th_current: "Atual",
    admin_th_shares: "Cotas",
    admin_investments_one: "investimento",
    admin_investments_many: "investimentos",
    admin_of: "de",
    admin_per_page: "/ página",
    admin_investor_current: "Valor Atual",
    admin_buys_ok: "✓ compras OK",
    admin_buys_pending: "⏳ pendente",
    admin_entry_nav: "NAV entrada: $",
    admin_pool_participation: "Participação no Pool",
    admin_shares_this: "Cotas deste investimento",
    admin_pool_pct: "% do Pool",
    admin_basket_comp: "Composição da Cesta",
    admin_sodex_pool_pct: "% do pool SoDEX",
    admin_testnet_warn_title: "Modo Testnet — dados financeiros não refletem a realidade",
    admin_testnet_warn_body: "Os portfólios testnet são simulados no banco de dados. O SoDEX testnet é um ambiente separado sem fundos reais — a reconciliação abaixo não tem significado financeiro.",
    admin_investor_col: "Investor",
    admin_usd_col: "USD",
  ...
  zh: {
    ...
    dash_risk_drift_desc: "目标权重偏差>8%时触发下次再平衡。",
    ...
    nav_ai_insights: "AI洞察",
    nav_faucet: "水龙头",
    nav_faucet_locked_hint: "切换到测试网以访问水龙头",
    ai_title: "AI洞察",
    ai_subtitle: "中期智能 · Scout SoSoMon",
    ai_updated_at: "更新于 {time}",
    ai_refresh: "刷新",
    ai_loading: "加载分析中...",
    ai_personalized_title: "个性化洞察",
    ai_view_index_link: "查看指数 →",
    ai_view_risk_link: "查看风险 →",
    ai_no_alerts: "暂无提醒 — 投资组合多元化良好。",
    ai_portfolio_ok: "投资组合状态良好 — 暂未发现机会或风险。",
    ai_connect_prompt: "连接钱包查看个性化洞察",
    ai_connect_btn: "连接钱包",
    ai_performance_title: "指数表现",
    ai_vs_btc: "vs BTC基准",
    ai_7d_col: "7天",
    ai_30d_col: "30天",
    ai_disclaimer: "洞察由Scout SoSoMon基于SoDEX和SoSoValue SSI真实数据生成。不构成投资建议。",
    dash_token_holdings: "代币持仓",
    dash_transaction_history: "交易记录",
    dash_no_perf_data: "暂无表现数据 — 图表每小时更新。",
    dash_chart_accumulating: "图表每小时积累数据 — 稍后查看完整曲线。",
    dash_alert_up: "上涨",
    dash_alert_down: "下跌",
    dash_this_week: "本周",
    dash_current_value_label: "当前价值",
    dash_updating: "更新中…",
    dash_nav_return_label: "NAV收益率% (自成立起)",
    idx_candidate_badge: "候选",
    idx_concentration_risk: "集中风险 (HHI)",
    idx_effective_n: "有效数量:",
    idx_max_label: "最大:",
    idx_vs_btc_label: "vs BTC 30d:",
    idx_alpha_label: "超额收益",
    wn_wave3_label: "Wave 3 · 2026年7月",
  ...
  ja: {
    ...
    dash_risk_drift_desc: "目標ウェイトから>8%乖離で次のリバランス。",
    ...
    nav_ai_insights: "AIインサイト",
    nav_faucet: "Faucet",
    nav_faucet_locked_hint: "FaucetはTestnetに切り替えてください",
    ai_title: "AIインサイト",
    ai_subtitle: "中期インテリジェンス · Scout SoSoMon",
    ai_updated_at: "{time}更新",
    ai_refresh: "更新",
    ai_loading: "分析を読み込み中...",
    ai_personalized_title: "パーソナライズドインサイト",
    ai_view_index_link: "インデックスを見る →",
    ai_view_risk_link: "リスクを見る →",
    ai_no_alerts: "現在アラートなし — ポートフォリオは十分に分散されています。",
    ai_portfolio_ok: "ポートフォリオは良好 — 現時点で機会やリスクは識別されていません。",
    ai_connect_prompt: "ウォレットを接続してパーソナライズドインサイトを見る",
    ai_connect_btn: "ウォレットを接続",
    ai_performance_title: "インデックスパフォーマンス",
    ai_vs_btc: "vs BTCベンチマーク",
    ai_7d_col: "7日間",
    ai_30d_col: "30日間",
    ai_disclaimer: "Scout SoSoMonがSoDEXとSoSoValue SSIのリアルデータを使用して生成したインサイトです。投資アドバイスではありません。",
    dash_token_holdings: "トークン保有",
    dash_transaction_history: "取引履歴",
    dash_no_perf_data: "まだパフォーマンスデータがありません — グラフは毎時更新されます。",
    dash_chart_accumulating: "グラフは毎時データを蓄積します — 後でご確認ください。",
    dash_alert_up: "上昇",
    dash_alert_down: "下落",
    dash_this_week: "今週",
    dash_current_value_label: "現在価値",
    dash_updating: "更新中…",
    dash_nav_return_label: "NAVリターン% (設定来)",
    idx_candidate_badge: "候補",
    idx_concentration_risk: "集中リスク (HHI)",
    idx_effective_n: "実効数:",
    idx_max_label: "最大:",
    idx_vs_btc_label: "vs BTC 30d:",
    idx_alpha_label: "アルファ",
    wn_wave3_label: "Wave 3 · 2026年7月",
    admin_founder_console: "Founder Console", admin_tab_overview: "Overview", admin_tab_proposals: "Proposals", admin_tab_indexes: "Indexes", admin_tab_treasury: "Treasury", admin_tab_investors_tab: "Investors", admin_tab_trades: "Trades", admin_tab_agents: "Agents", admin_pending_banner_one: "1 proposal pending approval", admin_pending_banner_many: "{n} proposals pending approval", admin_pending_banner_link: "View proposals →", admin_agent_health: "Agent Health", admin_manage_agents_link: "Manage agents →", admin_recent_activity: "Recent Activity", admin_view_all_link: "View all →", admin_scout_schedule: "Daily 06:00 UTC", admin_rebal_schedule: "Mon 08:00 + drift 4h", admin_nav_schedule: "Every 1h", admin_deposit_schedule: "Every 2min", admin_loading: "Loading...", admin_treasury_title: "Treasury", admin_fund_wallet_label: "Fund Wallet", admin_eth_critical_simple: "CRITICAL — replenish", admin_eth_low_simple: "Low — attention", admin_copy: "Copy", admin_copied: "Copied!", admin_sodex_portfolio_title: "SoDEX Portfolio", admin_mainnet_only_note: "(mainnet only)", admin_no_positions_short: "No positions", admin_movements_title: "Movements", admin_filter_all: "all", admin_filter_deposit: "deposit", admin_filter_refund: "refund", admin_filter_withdrawal: "withdrawal", admin_no_movements_filter: "No movements of type", admin_refund_status_ok: "ok", admin_refund_status_failed: "failed", admin_refund_status_pending: "pending", admin_trades_sodex_title: "Trades — SoDEX", admin_no_trades_sub2: "Trades appear after rebalance execution", admin_agents_controls_title: "Agents & Controls", admin_scout_agent_desc: "Analyzes SoDEX markets + SoSoValue SSI.", admin_run_scout: "Run Scout Now", admin_running_scout: "Running Scout...", admin_rebalancer_agent_desc: "Checks weight drift and proposes rebalancing.", admin_run_rebalancer_now: "Run Rebalancer Now", admin_running_rebalancer: "Running Rebalancer...", admin_nav_updater_agent_desc: "Fetches SoDEX prices, recalculates NAV and updates portfolios.", admin_run_nav_now: "Run NAV Update Now", admin_running_nav: "Updating NAV...", admin_report_agent_desc: "Generates a full management report.", admin_generate_report: "Generate Report", admin_generating: "Generating...", admin_on_demand: "On demand", admin_scheduler_title: "Scheduler", admin_prop_filter_all: "all", admin_prop_filter_pending: "pending", admin_prop_filter_approved: "approved", admin_prop_filter_executed: "executed", admin_prop_filter_rejected: "rejected", admin_no_proposals_filter: "No proposals with status", admin_scout_daily_note: "Scout runs daily at 06:00 UTC", admin_run_rebalancer_btn: "Run Rebalancer", admin_pending_count: "{n} pending", admin_investors_count: "{n} investors", admin_indexes_net: "Indexes — {net}",
  ...
  hi: {
    ...
    dash_risk_drift_desc: "लक्ष्य भार से >8% विचलन पर अगला रीबैलेंस।",
    ...
    nav_ai_insights: "AI इनसाइट्स",
    nav_faucet: "Faucet",
    nav_faucet_locked_hint: "Faucet के लिए Testnet पर स्विच करें",
    ai_title: "AI इनसाइट्स",
    ai_subtitle: "मध्यम-अवधि की बुद्धिमत्ता · Scout SoSoMon",
    ai_updated_at: "{time} पर अपडेट",
    ai_refresh: "ताज़ा करें",
    ai_loading: "विश्लेषण लोड हो रहा है...",
    ai_personalized_title: "व्यक्तिगत इनसाइट्स",
    ai_view_index_link: "इंडेक्स देखें →",
    ai_view_risk_link: "जोखिम देखें →",
    ai_no_alerts: "अभी कोई अलर्ट नहीं — पोर्टफोलियो विविध है।",
    ai_portfolio_ok: "पोर्टफोलियो अच्छी स्थिति में — कोई अवसर या जोखिम नहीं।",
    ai_connect_prompt: "व्यक्तिगत इनसाइट्स के लिए वॉलेट कनेक्ट करें",
    ai_connect_btn: "वॉलेट कनेक्ट करें",
    ai_performance_title: "इंडेक्स प्रदर्शन",
    ai_vs_btc: "vs BTC बेंचमार्क",
    ai_7d_col: "7 दिन",
    ai_30d_col: "30 दिन",
    ai_disclaimer: "Scout SoSoMon द्वारा SoDEX और SoSoValue SSI डेटा से बनाए गए इनसाइट्स। निवेश सलाह नहीं।",
    dash_token_holdings: "टोकन होल्डिंग्स",
    dash_transaction_history: "लेनदेन इतिहास",
    dash_no_perf_data: "अभी कोई डेटा नहीं — चार्ट हर घंटे अपडेट होता है।",
    dash_chart_accumulating: "चार्ट हर घंटे डेटा जमा करता है — बाद में देखें।",
    dash_alert_up: "बढ़ा",
    dash_alert_down: "गिरा",
    dash_this_week: "इस सप्ताह",
    dash_current_value_label: "वर्तमान मूल्य",
    dash_updating: "अपडेट हो रहा है…",
    dash_nav_return_label: "NAV रिटर्न % (शुरुआत से)",
    idx_candidate_badge: "उम्मीदवार",
    idx_concentration_risk: "एकाग्रता जोखिम (HHI)",
    idx_effective_n: "प्रभावी n:",
    idx_max_label: "सबसे बड़ा:",
    idx_vs_btc_label: "vs BTC 30d:",
    idx_alpha_label: "अल्फा",
    wn_wave3_label: "Wave 3 · जुलाई 2026",
    admin_founder_console: "Founder Console", admin_tab_overview: "Overview", admin_tab_proposals: "Proposals", admin_tab_indexes: "Indexes", admin_tab_treasury: "Treasury", admin_tab_investors_tab: "Investors", admin_tab_trades: "Trades", admin_tab_agents: "Agents", admin_pending_banner_one: "1 proposal pending approval", admin_pending_banner_many: "{n} proposals pending approval", admin_pending_banner_link: "View proposals →", admin_agent_health: "Agent Health", admin_manage_agents_link: "Manage agents →", admin_recent_activity: "Recent Activity", admin_view_all_link: "View all →", admin_scout_schedule: "Daily 06:00 UTC", admin_rebal_schedule: "Mon 08:00 + drift 4h", admin_nav_schedule: "Every 1h", admin_deposit_schedule: "Every 2min", admin_loading: "Loading...", admin_treasury_title: "Treasury", admin_fund_wallet_label: "Fund Wallet", admin_eth_critical_simple: "CRITICAL — replenish", admin_eth_low_simple: "Low — attention", admin_copy: "Copy", admin_copied: "Copied!", admin_sodex_portfolio_title: "SoDEX Portfolio", admin_mainnet_only_note: "(mainnet only)", admin_no_positions_short: "No positions", admin_movements_title: "Movements", admin_filter_all: "all", admin_filter_deposit: "deposit", admin_filter_refund: "refund", admin_filter_withdrawal: "withdrawal", admin_no_movements_filter: "No movements of type", admin_refund_status_ok: "ok", admin_refund_status_failed: "failed", admin_refund_status_pending: "pending", admin_trades_sodex_title: "Trades — SoDEX", admin_no_trades_sub2: "Trades appear after rebalance execution", admin_agents_controls_title: "Agents & Controls", admin_scout_agent_desc: "Analyzes SoDEX markets + SoSoValue SSI.", admin_run_scout: "Run Scout Now", admin_running_scout: "Running Scout...", admin_rebalancer_agent_desc: "Checks weight drift and proposes rebalancing.", admin_run_rebalancer_now: "Run Rebalancer Now", admin_running_rebalancer: "Running Rebalancer...", admin_nav_updater_agent_desc: "Fetches SoDEX prices, recalculates NAV and updates portfolios.", admin_run_nav_now: "Run NAV Update Now", admin_running_nav: "Updating NAV...", admin_report_agent_desc: "Generates a full management report.", admin_generate_report: "Generate Report", admin_generating: "Generating...", admin_on_demand: "On demand", admin_scheduler_title: "Scheduler", admin_prop_filter_all: "all", admin_prop_filter_pending: "pending", admin_prop_filter_approved: "approved", admin_prop_filter_executed: "executed", admin_prop_filter_rejected: "rejected", admin_no_proposals_filter: "No proposals with status", admin_scout_daily_note: "Scout runs daily at 06:00 UTC", admin_run_rebalancer_btn: "Run Rebalancer", admin_pending_count: "{n} pending", admin_investors_count: "{n} investors", admin_indexes_net: "Indexes — {net}",
  ...
  id: {
    ...
    dash_risk_drift_desc: "Rebalance berikutnya jika drift >8% dari bobot target.",
    ...
    nav_ai_insights: "AI Insights",
    nav_faucet: "Faucet",
    nav_faucet_locked_hint: "Beralih ke Testnet untuk mengakses faucet",
    ai_title: "AI Insights",
    ai_subtitle: "Kecerdasan jangka menengah · Scout SoSoMon",
    ai_updated_at: "diperbarui {time}",
    ai_refresh: "Perbarui",
    ai_loading: "Memuat analisis...",
    ai_personalized_title: "Insights personal",
    ai_view_index_link: "lihat indeks →",
    ai_view_risk_link: "lihat risiko →",
    ai_no_alerts: "Tidak ada peringatan saat ini — portofolio terdiversifikasi.",
    ai_portfolio_ok: "Portofolio dalam kondisi baik — tidak ada peluang atau risiko.",
    ai_connect_prompt: "Hubungkan dompet untuk melihat insights personal",
    ai_connect_btn: "Hubungkan dompet",
    ai_performance_title: "Performa indeks",
    ai_vs_btc: "vs BTC benchmark",
    ai_7d_col: "7 hari",
    ai_30d_col: "30 hari",
    ai_disclaimer: "Insights dibuat oleh Scout SoSoMon dengan data nyata SoDEX dan SoSoValue SSI. Bukan saran investasi.",
    dash_token_holdings: "Kepemilikan Token",
    dash_transaction_history: "Riwayat Transaksi",
    dash_no_perf_data: "Belum ada data performa — grafik diperbarui setiap jam.",
    dash_chart_accumulating: "Grafik mengumpulkan data setiap jam — cek lagi nanti.",
    dash_alert_up: "naik",
    dash_alert_down: "turun",
    dash_this_week: "minggu ini",
    dash_current_value_label: "nilai saat ini",
    dash_updating: "memperbarui…",
    dash_nav_return_label: "NAV Return % sejak awal",
    idx_candidate_badge: "kandidat",
    idx_concentration_risk: "Risiko Konsentrasi (HHI)",
    idx_effective_n: "n efektif:",
    idx_max_label: "terbesar:",
    idx_vs_btc_label: "vs BTC 30d:",
    idx_alpha_label: "alpha",
    wn_wave3_label: "Wave 3 · Jul 2026",
    admin_founder_console: "Founder Console", admin_tab_overview: "Overview", admin_tab_proposals: "Proposals", admin_tab_indexes: "Indexes", admin_tab_treasury: "Treasury", admin_tab_investors_tab: "Investors", admin_tab_trades: "Trades", admin_tab_agents: "Agents", admin_pending_banner_one: "1 proposal pending approval", admin_pending_banner_many: "{n} proposals pending approval", admin_pending_banner_link: "View proposals →", admin_agent_health: "Agent Health", admin_manage_agents_link: "Manage agents →", admin_recent_activity: "Recent Activity", admin_view_all_link: "View all →", admin_scout_schedule: "Daily 06:00 UTC", admin_rebal_schedule: "Mon 08:00 + drift 4h", admin_nav_schedule: "Every 1h", admin_deposit_schedule: "Every 2min", admin_loading: "Loading...", admin_treasury_title: "Treasury", admin_fund_wallet_label: "Fund Wallet", admin_eth_critical_simple: "CRITICAL — replenish", admin_eth_low_simple: "Low — attention", admin_copy: "Copy", admin_copied: "Copied!", admin_sodex_portfolio_title: "SoDEX Portfolio", admin_mainnet_only_note: "(mainnet only)", admin_no_positions_short: "No positions", admin_movements_title: "Movements", admin_filter_all: "all", admin_filter_deposit: "deposit", admin_filter_refund: "refund", admin_filter_withdrawal: "withdrawal", admin_no_movements_filter: "No movements of type", admin_refund_status_ok: "ok", admin_refund_status_failed: "failed", admin_refund_status_pending: "pending", admin_trades_sodex_title: "Trades — SoDEX", admin_no_trades_sub2: "Trades appear after rebalance execution", admin_agents_controls_title: "Agents & Controls", admin_scout_agent_desc: "Analyzes SoDEX markets + SoSoValue SSI.", admin_run_scout: "Run Scout Now", admin_running_scout: "Running Scout...", admin_rebalancer_agent_desc: "Checks weight drift and proposes rebalancing.", admin_run_rebalancer_now: "Run Rebalancer Now", admin_running_rebalancer: "Running Rebalancer...", admin_nav_updater_agent_desc: "Fetches SoDEX prices, recalculates NAV and updates portfolios.", admin_run_nav_now: "Run NAV Update Now", admin_running_nav: "Updating NAV...", admin_report_agent_desc: "Generates a full management report.", admin_generate_report: "Generate Report", admin_generating: "Generating...", admin_on_demand: "On demand", admin_scheduler_title: "Scheduler", admin_prop_filter_all: "all", admin_prop_filter_pending: "pending", admin_prop_filter_approved: "approved", admin_prop_filter_executed: "executed", admin_prop_filter_rejected: "rejected", admin_no_proposals_filter: "No proposals with status", admin_scout_daily_note: "Scout runs daily at 06:00 UTC", admin_run_rebalancer_btn: "Run Rebalancer", admin_pending_count: "{n} pending", admin_investors_count: "{n} investors", admin_indexes_net: "Indexes — {net}",
  ...
  ko: {
    ...
    dash_risk_drift_desc: "목표 비중 대비 >8% 이탈 시 다음 리밸런싱.",
    ...
    nav_ai_insights: "AI 인사이트",
    nav_faucet: "Faucet",
    nav_faucet_locked_hint: "Faucet를 사용하려면 Testnet으로 전환하세요",
    ai_title: "AI 인사이트",
    ai_subtitle: "중기 인텔리전스 · Scout SoSoMon",
    ai_updated_at: "{time} 업데이트",
    ai_refresh: "새로고침",
    ai_loading: "분석 로드 중...",
    ai_personalized_title: "개인화된 인사이트",
    ai_view_index_link: "인덱스 보기 →",
    ai_view_risk_link: "리스크 보기 →",
    ai_no_alerts: "현재 알림 없음 — 포트폴리오가 잘 분산되어 있습니다.",
    ai_portfolio_ok: "포트폴리오 양호 — 현재 기회나 리스크가 없습니다.",
    ai_connect_prompt: "개인화된 인사이트를 보려면 지갑을 연결하세요",
    ai_connect_btn: "지갑 연결",
    ai_performance_title: "인덱스 성과",
    ai_vs_btc: "vs BTC 벤치마크",
    ai_7d_col: "7일",
    ai_30d_col: "30일",
    ai_disclaimer: "Scout SoSoMon이 SoDEX 및 SoSoValue SSI 실제 데이터로 생성한 인사이트입니다. 투자 조언이 아닙니다.",
    dash_token_holdings: "토큰 보유",
    dash_transaction_history: "거래 내역",
    dash_no_perf_data: "아직 성과 데이터 없음 — 차트는 매시간 업데이트됩니다.",
    dash_chart_accumulating: "차트는 매시간 데이터를 축적합니다 — 나중에 다시 확인하세요.",
    dash_alert_up: "상승",
    dash_alert_down: "하락",
    dash_this_week: "이번 주",
    dash_current_value_label: "현재 가치",
    dash_updating: "업데이트 중…",
    dash_nav_return_label: "NAV 수익률% (설정 이후)",
    idx_candidate_badge: "후보",
    idx_concentration_risk: "집중 위험 (HHI)",
    idx_effective_n: "유효 n:",
    idx_max_label: "최대:",
    idx_vs_btc_label: "vs BTC 30d:",
    idx_alpha_label: "알파",
    wn_wave3_label: "Wave 3 · 2026년 7월",
    admin_founder_console: "Founder Console", admin_tab_overview: "Overview", admin_tab_proposals: "Proposals", admin_tab_indexes: "Indexes", admin_tab_treasury: "Treasury", admin_tab_investors_tab: "Investors", admin_tab_trades: "Trades", admin_tab_agents: "Agents", admin_pending_banner_one: "1 proposal pending approval", admin_pending_banner_many: "{n} proposals pending approval", admin_pending_banner_link: "View proposals →", admin_agent_health: "Agent Health", admin_manage_agents_link: "Manage agents →", admin_recent_activity: "Recent Activity", admin_view_all_link: "View all →", admin_scout_schedule: "Daily 06:00 UTC", admin_rebal_schedule: "Mon 08:00 + drift 4h", admin_nav_schedule: "Every 1h", admin_deposit_schedule: "Every 2min", admin_loading: "Loading...", admin_treasury_title: "Treasury", admin_fund_wallet_label: "Fund Wallet", admin_eth_critical_simple: "CRITICAL — replenish", admin_eth_low_simple: "Low — attention", admin_copy: "Copy", admin_copied: "Copied!", admin_sodex_portfolio_title: "SoDEX Portfolio", admin_mainnet_only_note: "(mainnet only)", admin_no_positions_short: "No positions", admin_movements_title: "Movements", admin_filter_all: "all", admin_filter_deposit: "deposit", admin_filter_refund: "refund", admin_filter_withdrawal: "withdrawal", admin_no_movements_filter: "No movements of type", admin_refund_status_ok: "ok", admin_refund_status_failed: "failed", admin_refund_status_pending: "pending", admin_trades_sodex_title: "Trades — SoDEX", admin_no_trades_sub2: "Trades appear after rebalance execution", admin_agents_controls_title: "Agents & Controls", admin_scout_agent_desc: "Analyzes SoDEX markets + SoSoValue SSI.", admin_run_scout: "Run Scout Now", admin_running_scout: "Running Scout...", admin_rebalancer_agent_desc: "Checks weight drift and proposes rebalancing.", admin_run_rebalancer_now: "Run Rebalancer Now", admin_running_rebalancer: "Running Rebalancer...", admin_nav_updater_agent_desc: "Fetches SoDEX prices, recalculates NAV and updates portfolios.", admin_run_nav_now: "Run NAV Update Now", admin_running_nav: "Updating NAV...", admin_report_agent_desc: "Generates a full management report.", admin_generate_report: "Generate Report", admin_generating: "Generating...", admin_on_demand: "On demand", admin_scheduler_title: "Scheduler", admin_prop_filter_all: "all", admin_prop_filter_pending: "pending", admin_prop_filter_approved: "approved", admin_prop_filter_executed: "executed", admin_prop_filter_rejected: "rejected", admin_no_proposals_filter: "No proposals with status", admin_scout_daily_note: "Scout runs daily at 06:00 UTC", admin_run_rebalancer_btn: "Run Rebalancer", admin_pending_count: "{n} pending", admin_investors_count: "{n} investors", admin_indexes_net: "Indexes — {net}",
